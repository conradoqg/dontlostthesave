...
Function welcome
	...
	${NSD_CreateLabel} 185 1u 210 100% "Welcome to ${name} version ${version} installer.$\r$\n$\r$\nClick install to begin."
...
Section "Install"
	...
	WriteRegStr HKLM "${uninstkey}" "DisplayIcon" '"$INSTDIR\dontlostthesave.ico"'
	...
	CreateShortCut "$SMPROGRAMS\${name}.lnk" "$INSTDIR\${exec}" "" "$INSTDIR\dontlostthesave.ico"
...
UninstallText "Don't like ${name} anymore? Hit uninstall button."
UninstallIcon "${icon}"
...
Function un.confirm
	...
	${NSD_CreateLabel} 1u 1u 100% 24u "If you really want to remove ${name} from your computer press uninstall button."

	${NSD_CreateCheckbox} 1u 35u 100% 10u "Remove also my ${name} personal data"
